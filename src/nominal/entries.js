...
const GREEK = "[\\p{Script=Greek}]",
      ...
      DECIMAL = "[0-9]",
      LATIN_LOWER_CASE = "[\\p{Script=Latin}&&\\p{Ll}]",
      LATIN_UPPER_CASE = "[\\p{Script=Latin}&&\\p{Lu}]",
...
const entries = [
  {
    "primary-keyword": "^(?:Rule|Axiom|Theorem|Lemma|Conjecture|Schema|Premises|Premise|Conclusion|Proof|Therefore|Suppose|Hence|Then|Provisional|Type|TypeAlias|TypePrefix|Properties|Property|Variable|Combinator|Constructor|Generator|Metavariable|Given|Closed)\\b"
  },
  {
