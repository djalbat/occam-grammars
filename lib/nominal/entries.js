...
var entries = [
    ...
    {
        "identifier": "^(?:".concat(LATIN, "+").concat(DECIMAL, "*|").concat(GREEK, "+|").concat(SANS_SERIF, "+|").concat(FRAKTUR, "+|").concat(SCRIPT, "+)")
    },
    {
        "delimiter": "^(?:\\.\\.\\.|,|\\(|\\)|\\[|\\])"
    },
